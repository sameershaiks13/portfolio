    ...
    <section id="about" className="about-wrapper">
      ...
      <div ref={containerRef} className="about-scroll">
        <div className="about-sticky">
          ...
          >
            <img src="./proimage3.png" alt="Profile" />
          </div>
          ...
          >
            <div className="info-inner">
              ...
              <p>
                I’m Shaik Mohammed Sameer, a tech-driven learner passionate about building real-world solutions.
              ...
              <p>
                4th-year B.Tech CSE Engineering student with hands-on experience in ML & DL Projects.
      ...
      <div className={`about-hobbies ${hobbiesVisible ? "hobbies-show" : "hobbies-hidden"}`}>
        ...
        <div className="hobby-grid">
          ...
          <div className="hobby">📷 video editing </div>
