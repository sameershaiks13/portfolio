...
export function FloatingNav() {
  const socialLinks = [
    { icon: Github, href: 'https://github.com/sameershaiks13', label: 'GitHub' },
    { icon: Linkedin, href: 'https://www.linkedin.com/in/sameershaik13/', label: 'LinkedIn' },
    { icon: Twitter, href: '#', label: 'Twitter' },
    { icon: Instagram, href: 'https://www.instagram.com/sameer_x_shaik/', label: 'Instagram' },
    { 
      icon: () => (
      ...
      href: 'https://leetcode.com/u/shaikmohammedsameeer/', 
      label: 'LeetCode' 
    },
    { icon: Mail, href: 'mailto:shaikmohammedsameer13@gmail.com', label: 'Email' },
  ];
