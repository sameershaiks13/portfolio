...
export function Home({ theme }: HeroProps) {
  ...
  const connectLinks = [
    { img: linkedinLogo, link: "https://www.linkedin.com/in/sameershaik13/" },
    { img: gmailLogo, link: "mailto:shaikmohammedsameer13@gmail.com" },
    { img: whatsappLogo, link: "https://wa.me/+919347773294" },
    { img: instagramLogo, link: "https://www.instagram.com/sameer_x_shaik/" },
    { img: facebookLogo, link: "https://www.facebook.com/share/1JgcT7jY15/" },
  ];

  const workLinks = [
    { img: githubLogo, link: "https://github.com/sameershaiks13" },
    { img: leetcodeLogo, link: "https://leetcode.com/u/shaikmohammedsameeer/" },
  ];
  ...
  return (
    <section id="home" className="hero">
      <div
        className="hero-bg"
        style={{
          backgroundImage: `url(${theme === "light" ? "/proimage2.png" : "/proimage.png"})`,
        }}
      />
      ...
      <motion.div className="hero-content" variants={containerVariants} initial="hidden" animate="visible">
        <motion.h1 className="hero-name" variants={itemVariants}>
          Hi! I’m <br />
          <span className="gradient-text hero-name-line">Shaik Mahammad Sameer</span>
        ...
        <motion.div className="hero-info" variants={itemVariants}>
          {[
            ...
            { label: "📞 Contact", value: "shaikms133@gmail.com" },
          ].map((info, i) => (
