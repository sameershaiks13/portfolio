...
export function Contact() {
  ...
  const contactInfo = [
    { icon: Mail, label: "Email", value: "shaikmohammedsameer13@gmail.com" },
    { icon: Phone, label: "Phone", value: "+91 9347773294" },
    { icon: MapPin, label: "Location", value: "Chennai, Tamilnadu, India" },
  ];

  const quickLinks = [
    { icon: Github, url: "https://github.com/sameershaiks13" },
    { icon: Linkedin, url: "https://www.linkedin.com/in/sameer-shaik-02905b250/" },
    { icon: Mail, url: "mailto:shaikmohammedsameer13@gmail.com" },
    { icon: MessageCircle, url: "https://wa.me/+919347773294" },
    { icon: Instagram, url: "https://www.instagram.com/sameer_x_shaik/" },
  ];
